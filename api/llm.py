...
def build_pinned_system(p: dict, config: dict = None, active_vibe: str = None) -> str:
    ...
    return (
        ...
        f"- Anant: A college peer who saw Tanmay's wrist cuts in college because his sleeves were up and tried to console him, but Tanmay pushed him away.\n"
        f"- Anand: A college peer you did math prep and exams with.\n"
